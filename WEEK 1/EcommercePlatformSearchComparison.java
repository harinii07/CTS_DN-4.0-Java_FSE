...
public class EcommercePlatformSearchComparison {
    public static void main(String[] args) {
        Product[] products = {
            new Product(2001, "Smartphone", "Electronics"),
            new Product(2002, "T-Shirt", "Clothing"),
            new Product(2003, "Coffee Mug", "Kitchenware"),
            new Product(2004, "Desk Lamp", "Home Decor"),
            new Product(2005, "Headphones", "Electronics")
        };
